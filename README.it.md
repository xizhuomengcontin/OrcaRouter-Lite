...
> **Railway:** monta un volume su `/data` e imposta `DATABASE_URL=sqlite+aiosqlite:////data/orca.db`, altrimenti ogni redeploy cancella chiavi e analytics. Elenco completo delle variabili: [`railway.toml`](./railway.toml).
